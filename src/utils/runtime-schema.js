...
const SCHEMA_GROUPS = [
  ...
  {
    key: 'stage33-pumpfun-post-migration-blast-detections',
    name: 'Stage 33 PumpFun post-migration blast detection persistence',
    repair: 'node src/utils/db-init-stage33.js',
    tables: [
      {
        table: 'pumpfun_post_migration_blast_detections',
        columns: [
          'token_address',
          'symbol',
          'name',
  ...
  {
    key: 'stage34-pumpfun-combo-confirmation-detections',
    name: 'Stage 34 PumpFun combo confirmation detection persistence',
    repair: 'node src/utils/db-init-stage34.js',
    tables: [
      {
        table: 'pumpfun_combo_confirmation_detections',
        columns: [
          'token_address',
          'symbol',
          'name',
