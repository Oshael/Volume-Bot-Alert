...
const LOW_NEAR_RECHECK_MS = 20 * 1000;
const LOW_DUST_RECHECK_MS = 10 * 60 * 1000;
const NORMAL_RECHECK_MS = 5 * 1000;
const NORMAL_BOOST_6H_RECHECK_MS = 5 * 1000;
const NORMAL_BOOST_1H_RECHECK_MS = 5 * 1000;
const HIGH_HOT_RECHECK_MS = 5 * 1000;
const HIGH_WARM_RECHECK_MS = 5 * 1000;
