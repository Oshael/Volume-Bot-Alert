  ...
  it('summarizes population recurrence without exposing candidate wallets', () => {
    const report = summarizePopulationRecurrence([
      ...
      { walletAddress: WALLET_A, tokenAddress: 'token-b', volumeUsd: '25',
        anchorReady: true, withinOneBlock: true, buyerRank: 5, positionReady: true },
      { walletAddress: WALLET_A, tokenAddress: 'token-c', volumeUsd: null,
        anchorReady: true, withinOneBlock: true, buyerRank: 1, positionReady: true },
      { walletAddress: WALLET_B, tokenAddress: 'token-d', volumeUsd: '100',
        anchorReady: true, withinOneBlock: true, buyerRank: 1, positionReady: false },
      { walletAddress: WALLET_B, tokenAddress: 'token-e', volumeUsd: '100',
        anchorReady: false, withinOneBlock: false, buyerRank: 1, positionReady: true },
      { walletAddress: WALLET_B, tokenAddress: 'token-f', volumeUsd: '100',
        anchorReady: true, withinOneBlock: false, buyerRank: 1, positionReady: true },
    ...
    const runtime = {
      ...
      recurrenceSource: { loadPopulationRecurrence: async (wallets) => {
        ...
        return [{
          ...
          volumeUsd: '12', anchorReady: true, withinOneBlock: true,
          buyerRank: 1, positionReady: true,
        }];
      } },
    };
