...
describe('runtime worker groups config', () => {
  ...
  it('bounds the Robinhood retention worker maintenance controls', () => {
    ...
    withEnv({
      ...
      ROBINHOOD_CANONICAL_RAW_RETENTION_ENABLED: 'true',
      ROBINHOOD_RETENTION_POSITION_PREIMAGE_PRUNE_ENABLED: 'true',
  ...
  it('keeps all isolated holder workers opt-in and bounded', () => {
    ...
    withEnv({
      ...
      ROBINHOOD_HOLDER_GLOBAL_BACKFILL_ADDRESS_FILTER_LIMIT: '9999',
      ...
      assert.equal(config.robinhoodHolderGlobalBackfillWorker.addressFilterLimit, 1000);
    ...
    withEnv({
      ...
      ROBINHOOD_HOLDER_LIVE_MAX_HANDOFFS: '99',
      ROBINHOOD_HOLDER_LIVE_HANDOFF_MAX_DURATION_MS: '99999',
      ROBINHOOD_HOLDER_LIVE_CONFIRMATIONS: '9999',
      ROBINHOOD_HOLDER_LIVE_MAX_APPLY_EVENTS: '999999',
      ROBINHOOD_HOLDER_LIVE_SHADOW_PROMOTION_BATCH_SIZE: '999999',
      ROBINHOOD_HOLDER_LIVE_APPLY_CONCURRENCY: '99',
      ...
      ROBINHOOD_HOLDER_JOURNAL_RETENTION_MS: '9999999999',
      ...
      assert.deepEqual(config.robinhoodHolderLiveApplyWorker, {
        ...
        concurrency: 8, maxApplyEvents: 50_000, shadowPromotionBatchSize: 1000,
        applyBatchSize: 1000,
  ...
  it('keeps live token deployment resolution opt-in and bounded', () => {
    withEnv({
      ...
      ROBINHOOD_TOKEN_DEPLOYMENT_LIVE_TRACE_ENABLED: 'true',
      ROBINHOOD_TOKEN_DEPLOYMENT_LIVE_TRACE_BATCH_SIZE: '99',
      ROBINHOOD_TOKEN_DEPLOYMENT_LIVE_TRACE_TIMEOUT_MS: '99999',
      ROBINHOOD_TOKEN_DEPLOYMENT_LIVE_TRACE_MAX_AGE_MS: '1',
      ...
      traceEnabled: true, traceBatchSize: 8, traceTimeoutMs: 5000, traceMaxAgeMs: 60_000,
    }));
  });
