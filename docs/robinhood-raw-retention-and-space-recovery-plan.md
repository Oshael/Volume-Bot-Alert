...
| Reorg e reclassificação | Stage 244 grava disposições append-only; o comando de reclassificação ainda enumera e atualiza raw | As duas tabelas não tornam o raw descartável. |
